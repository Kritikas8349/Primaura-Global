    ...
    <>
      <section className="newProductsHero">
        ...
        <div className="newProductsContainer">
          <div className="newProductsContent">
            <span className="newProductsSubtitle">PRIMAURA GLOBAL</span>

            <h1 className="newProductsHeading">Our Products</h1>

            <p className="newProductsDescription">
              Explore our premium range of Indian export products, carefully
              sourced and processed to meet international quality standards.
              From authentic spices and herbs to pharmaceutical products, we
              deliver excellence with every shipment worldwide.
            </p>
            ...
            <div className="newProductsFeatures">
              <div className="newProductsFeatureCard">
                ...
                <p>
                  Naturally sourced ingredients with premium quality assurance.
                </p>
              </div>
              ...
              <div className="newProductsFeatureCard">
                ...
                <p>
                  Carefully processed following international export standards.
                </p>
              </div>
              ...
              <div className="newProductsFeatureCard">
                ...
                <p>Supplying trusted products to customers across the world.</p>
              </div>
              ...
              <div className="newProductsFeatureCard">
                ...
                <p>
                  Reliable partnerships with commitment and timely delivery.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="catalogSection">
        <div className="catalogContainer">
          <span className="catalogSubtitle">PRIMAURA GLOBAL</span>

          <h2 className="catalogHeading">Our Product Catalog</h2>
            ...
            {products.map((product) => (
              <button
                ...
                className={`catalogTab ${
                  activeProduct.id === product.id ? "activeTab" : ""
                }`}
